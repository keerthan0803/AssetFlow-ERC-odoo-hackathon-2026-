      ...
      <div className="hidden lg:flex w-1/2 relative bg-[#0B132B] text-white flex-col justify-between p-12 overflow-hidden">
        ...
        <div className="relative z-10 flex items-center gap-3">
          <div className="flex items-center justify-center">
            <img src="/favicon.jpg" alt="AssetFlow Logo" className="w-12 h-12 object-contain rounded-md" />
          </div>
          <div className="flex flex-col justify-center">
            <h1 className="text-3xl font-bold tracking-tight leading-none mb-1">AssetFlow</h1>
            <p className="text-xs font-semibold text-gray-300 tracking-wider leading-none">Enterprise ERP</p>
          </div>
        </div>
